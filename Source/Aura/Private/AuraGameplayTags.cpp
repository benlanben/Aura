...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Primary_Intelligence = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Increases magical damage, MaxMana and Mana regeneration")
		);
	...
	GameplayTags.Attributes_Secondary_Armor = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Reduces damage taken, improves Block Chance and Critical Hit Resistance")
		);
	...
	*/
	...
	GameplayTags.Message_HealthPotion = UGameplayTagsManager::Get().AddNativeGameplayTag(
		...
		FString("Health Potion on screen message")
		);
	GameplayTags.Message_ManaPotion = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Message.ManaPotion"),
		FString("Mana Potion on screen message")
		);
	GameplayTags.Message_CrystalPotion = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Message.CrystalPotion"),
		FString("Crystal Potion on screen message")
		);
